...
const Introduction = () => {
  return (
    <section className=' pt-40 px-5 flex w-full mx-auto flex-col justify-center items-start max-w-7xl'>
      ...
      <a className=' mt-10 px-10 py-4 text-center align-middle rounded bg-secondary text-sm text-primary_dark tracking-widest uppercase font-extrabold' href=''>Explore my work</a>

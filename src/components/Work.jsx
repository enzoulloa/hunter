    ...
    <article ref={animateRef} className='w-full flex flex-col items-stretch transition duration-700 ease-in opacity-0 '>
      ...
      <button onClick={handleButtonClick} className=' flex mt-5 py-4 px-12 justify-between items-center self-end rounded bg-secondary text-primary text-sm uppercase font-extrabold cursor-pointer'>View full gallery
        {button
          ...
          : <svg stroke='currentColor' fill='currentColor' strokeWidth='0' viewBox='0 0 24 24' height='20' width='20' xmlns='http://www.w3.org/2000/svg'><path fill='none' d='M0 0h24v24H0z' /><path d='M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z' /></svg>}
      </button>
    </article>
  )
}

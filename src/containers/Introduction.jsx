  ...
  return (
    <section ref={animateRef} id='introduction' className=' pt-40 px-5 md:pt-[180px] md:px-10 flex w-full mx-auto flex-col justify-center items-start max-w-[1360px] transition duration-700 ease-in opacity-0 lg:pt-[220px] lg:px-[5%] lg:pb-[120px] relative'>
      <div className=' flex w-full flex-col items-start max-w-[600px]'>
        ...
        <a className=' flex items-center mt-10 px-8 md:px-10 py-4 text-center align-middle rounded bg-secondary text-sm text-primary_dark tracking-widest uppercase font-extrabold' href='#works'>Explore my work
      ...
      <img className=' w-[280px] h-[280px] mt-10 opacity-80 lg:absolute lg:left-auto lg:top-auto lg:right-0 lg:bottom-0 max-h-[90%] -z-10 md:w-[688px] md:h-[688px] lg:w-[700px] lg:h-[700px]' src={img} alt='Introduction Image' loading='eager' />
    </section>
  )
}
